...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Xn,depthTest:!1,depthWrite:!1})}function Id(){return new Gt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:qo(),fragmentShader:`
		...
		`,blending:Xn,depthTest:!1,depthWrite:!1})}function Nd(){return new Gt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:qo(),fragmentShader:`
